// JSON2: create a global JSON object containing two methods: stringify() and parse().
// Source: http://cdnjs.cloudflare.com/ajax/libs/json2/20140204/json2.min.js
...
// Avoid error when console.log is not defined (e.g. IE9)
if (!window.console) window.console = {};
if (!window.console.log) window.console.log = function () { };

// Extend String class: format() works similar to sprintf() in C
...
// Extend Function: define bindToContext() which allows to save context throughout the whole session.
Function.prototype.bindToContext = function (scope) {
    var fn = this;
    return function () {
